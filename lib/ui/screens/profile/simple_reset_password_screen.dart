...
class SimpleResetPasswordScreen extends StatefulWidget {
  ...
  const SimpleResetPasswordScreen({
    super.key,
    required this.email,
  ...
  @override
  State<SimpleResetPasswordScreen> createState() => _SimpleResetPasswordScreenState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Enter the code below to verify your email, then Firebase will send you a password reset link.',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey[600],
                      ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _isVerifying ? null : _verifyAndSendReset,
                  child: _isVerifying
                      ? const SizedBox(
                          width: 20,
                          height: 20,
